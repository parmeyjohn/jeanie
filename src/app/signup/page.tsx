...
export default function SignUp() {
    ...
    return (
        <div className='w-screen h-screen flex justify-center items-center'>
            <div className="relative border border-indigo-400 bg-indigo-50 rounded-lg shadow-xl w-96 h-auto -top-24 p-4">
                ...
                <h1 className="text-xl font-semibold m-2 my-">Sign up</h1>
                <form className="m-2 my-4" onSubmit={signUp}>
                    <div className="m-2 flex flex-col">
                        <label htmlFor="email-signup-input">Email:</label>
                        <input autoFocus={true} id='email-signup-input' className="border border-indigo-400 p-2 mt-1 rounded-md outline-indigo-800 transition-all  ease-in-out duration-100" value={email} onChange={(e) => setEmail(e.target.value)}>
                        </input>
                    </div>
                    <div className="m-2 flex flex-col">
                        <label htmlFor="password-signup-input">Password:</label>
                        <input id='password-signup-input' className="border border-indigo-400 p-2 mt-1 rounded-md outline-indigo-800 transition-all  ease-in-out duration-100" value={password} onChange={(e) => setPassword(e.target.value)}>
                        </input>
                    </div>
                ...
                <div className="border-t-2 border-slate-400 m-2 flex justify-center">
                    <div className="mt-4 flex flex-col items-center">
                        <h3 className="text-sm mb-4">Have an account?</h3>
